            ...
            if (obj.has("text")) {
                ...
                return ContentJson(
                    ...
                    FfiReactionPayload(
                        ...
                        content = reaction.get("content").asString,
                        referenceInboxId = if (reaction.has("referenceInboxId")) reaction.get("referenceInboxId").asString else "",
                    ),
                )
    ...
    fun toJsonMap(): Map<String, Any> =
        when (type.id) {
            ...
            ContentTypeMultiRemoteAttachment.id -> {
                ...
                val attachmentMaps =
                    multiRemoteAttachment.attachments.map { attachment ->
                        mapOf(
                            "scheme" to "https://",
                ...
                mapOf(
                    "reaction" to
                        mapOf(
                            ...
                            "action" to
                                content.action.javaClass.simpleName
                                    .lowercase(),
                            "schema" to
                                content.schema.javaClass.simpleName
                                    .lowercase(),
                ...
                mapOf(
                    "reaction" to
                        mapOf(
                            ...
                            "referenceInboxId" to reaction.referenceInboxId,
                ...
                mapOf(
                    "groupUpdated" to
                        mapOf(
                            ...
                            "membersAdded" to
                                content.addedInboxesList.map {
                                    mapOf(
                                        "inboxId" to it.inboxId,
                                    )
                                },
                            "membersRemoved" to
                                content.removedInboxesList.map {
                                    mapOf(
                                        "inboxId" to it.inboxId,
                                    )
                                },
                            "metadataFieldsChanged" to
                                content.metadataFieldChangesList.map {
                                    mapOf(
