...
export class Client<ContentTypes> {
  ...
  private static signSubscription: EmitterSubscription | null = null
  private static authSubscription: EmitterSubscription | null = null
  ...
  private static setupSubscriptions(opts: ClientOptions): {
    enableSubscription?: EmitterSubscription
    createSubscription?: EmitterSubscription
  } {
