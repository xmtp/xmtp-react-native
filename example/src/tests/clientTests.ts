...
test('static can get log files', async () => {
  ...
  Client.activatePersistentLibXMTPLogWriter(LogLevel.DEBUG, LogRotation.HOURLY, 10)
  await new Promise(resolve => setTimeout(resolve, 3000))
  ...
  if (logFilePaths.length > 0) {
    ...
    // assert(!
    //   logContent.includes('0x4E9ce36E442e55EcD9025B9a6E0D88485d628A67'),
    //   'Log file should not contain the address 0x4E9ce36E442e55EcD9025B9a6E0D88485d628A67'
    // )
  } else {
    return false
  }
